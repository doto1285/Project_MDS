...
public class SPF_OrderService {
	...
	public List<BasketListVo> insertOrder(List<Map<String, Object>> resultMap, int mall_no) {
		...
		for (Map<String, Object> map : resultMap) {
			...
			basketListVo.setBasket_count(Integer.parseInt(String.valueOf(map.get("basket_count"))));
			...
			basketListVo.setProductoption_no(Integer.parseInt(String.valueOf(map.get("productoption_no"))));
	...
	public List<BasketListVo> insertOrderOfBasket(List<Map<String, Object>> resultMap, int mall_no) {
		List<BasketListVo> orderList = new ArrayList<BasketListVo>();
		for (Map<String, Object> map : resultMap) {
			BasketListVo basketListVo = new BasketListVo();
