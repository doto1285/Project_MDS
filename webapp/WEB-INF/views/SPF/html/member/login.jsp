		...
		<div id="loginForm">
			<form class="form-inline">
				<div class="form-group">
					<label for="exampleInputName2" id="loginText">아이디 &nbsp;
						&nbsp;</label> <input type="text" class="form-control"
						id="exampleInputName2" placeholder="아이디">
				</div>
				<br> <br>
				<div class="form-group" id="passwordForm">
					<label for="exampleInputPassword3" id="loginText">비밀번호
						&nbsp; &nbsp;</label> <input type="password" class="form-control"
						id="exampleInputPassword3" placeholder="비밀번호">
				</div>
			</form>
			<br>
			<button id="loginButton" type="submit" class="btn btn-default btn-lg">로그인</button>
		</div>
		<div id="loginFormBottomLabel">
			<label id="loginText"><a href="">아이디 찾기</a></label> <label id="loginText">&nbsp;|&nbsp;</label>
			<label id="loginText"><a href="">비밀번호 찾기</a></label> <label id="loginText">&nbsp;|&nbsp;</label>
			<label id="loginText"><a href="./join">회원가입</a></label>
		</div>
	</div>
	<br>
	<br>
