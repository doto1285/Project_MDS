...
<body>
	...
	<h3>게시판 관리</h3>
	<!-- --------------------------------------------- -->
	<div class="col-md-10" id="margin50px">
...
var msgchangecateNo = "";
	...
	$(".btn_catePMod").on("click", function() {
		...
		boardlistname = $(this).parents("tr").data("boardlistname");
		writeaccessright = $(this).parents("tr").data("writeaccessright");
		readaccessright = $(this).parents("tr").data("readaccessright");

		$("#recipient_name").val(boardlistname);

		console.log("수정버튼 클릭시: " + boardlistno + boardlistname + writeaccessright +""+ readaccessright); //로그에 찍히는 부분
	...
	$(".btn_catePModalSave").on("click", function() {
		...
		console.log("변경할 번호 : " + boardlistno + boardlistname + writeaccessright + readaccessright);
